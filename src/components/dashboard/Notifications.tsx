...
// It shows a list of notifications for the logged-in user.

// These notifications come from Supabase database and include things like:

// Lawyer replies 💬
// Case status updates 📄
// Case accepted/rejected 👨‍⚖️
// System alerts ⚠️